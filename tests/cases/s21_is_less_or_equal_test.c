...
START_TEST(different_signs_one_le) {
...
START_TEST(different_signs_two_le) {
  s21_decimal value_1 = {10, 10, 10, 0};
  s21_decimal value_2 = {10, 10, 10, 0};
...
START_TEST(different_values_one_le) {
...
START_TEST(different_values_two_le) {
  s21_decimal value_1 = {10, 10, 10, 0};
