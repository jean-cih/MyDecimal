...
START_TEST(different_signs_one_g) {
...
START_TEST(different_signs_two_g) {
  s21_decimal value_1 = {10, 10, 10, 0};
  s21_decimal value_2 = {10, 10, 10, 0};
...
START_TEST(different_values_one_g) {
...
START_TEST(different_values_two_g) {
  s21_decimal value_1 = {10, 10, 10, 0};
